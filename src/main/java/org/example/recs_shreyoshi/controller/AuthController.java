...
import org.example.recs_shreyoshi.dto.ProfileResponse;
import org.example.recs_shreyoshi.dto.UserUpdateDTO;
...
import org.example.recs_shreyoshi.services.JwtService;
...
@CrossOrigin(
        origins = "${frontend.origin:http://localhost:3000}",
